...
class RequestEditModal extends Component{
  constructor(props){
      super(props);
      this.state={
          open: true,
  ...
  componentDidMount(){
      ...
      this.setState({
          ...
          hospital: this.props.request.hospital,
          type: this.props.request.type,
          city: this.props.request.city,
          contact: this.props.request.contact,
  ...
  formSubmitted = (e) =>{
      ...
      requestSchema.validate(data)
        .then(() => {
          return this.props.editRequest(data)
            .then(() => {
...
function mapDispatchToProps(dispatch) {
  ...
  export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(RequestEditModal));